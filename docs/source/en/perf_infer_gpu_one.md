...
FlashAttention-2 supports inference with Llama, Mistral, Falcon, Persimmon and Bark models. You can request to add FlashAttention-2 support for another model by opening a GitHub Issue or Pull Request.
