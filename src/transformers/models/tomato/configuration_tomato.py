...
TOMATO_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "adept/tomato-8b-base": "https://huggingface.co/adept/tomato-8b-base/resolve/main/config.json",
}
...
class TomatoConfig(PretrainedConfig):
    ...
    Tomato model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the
    [adept/tomato-8b-base](https://huggingface.co/adept/tomato-8b-base).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 262144):
            Vocabulary size of the Tomato model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`TomatoForCausalLM`]
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            https://www.reddit.com/r/LocalTomato/comments/14mrgpr/dynamically_scaled_rope_further_increases/. This is an
    ...
    ```python
    >>> from transformers import TomatoConfig
