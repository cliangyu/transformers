...
def write_to_file(file_path, current_path, content, mode='a', add_timestamp=True):
...
class TomatoProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py input text", str(text))   
        write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py input images to call", str(images))
        ...
        write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py batch_images", str(batch_images))
        ...
        for prompt, scale_factor, image_unpadded_height, image_unpadded_width, tensor_batch_image in zip(
            ...
            write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py sample_encoding", str(sample_encoding))

            all_encodings.append(sample_encoding)

            write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py all_encodings", str(all_encodings))
        ...
        write_to_file("/p/scratch/ccstdl/xu17/tomato/tomato_test_code/tomato_log.txt", "processing_tomato.py batch_encoding", str(batch_encoding))
